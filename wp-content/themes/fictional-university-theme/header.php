    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <ul>
            <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 1) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/about-us') ?>">About Us</a></li>
        ...
        <div class="site-header__util">
          <?php if (is_user_logged_in()) { ?>
            ...
            <!-- Add 'btn--with-photo' to the class below to display Gravatar -->
